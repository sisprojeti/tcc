...
<div class="content-header navbar-white">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Cadastro Administrador</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Cadastro Administrador</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="form-group navbar-white" style="text-align: center;">
    ...
    <input style="width: 20%; height: 6%;" type="submit" name="button" value="Salvar" class="btn btn-success" >
</div>
</form>
    <!-- /.row (main row) -->
      </div><!-- /.container-fluid -->
