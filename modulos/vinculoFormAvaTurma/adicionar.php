<?php
include_once('classes/class.refFormAvaTurma.php');
include('classes/class.exercicio.php');

if(isset($_POST['button']) && $_POST['button'] === 'Salvar'){
  try {
    $novaRefFormAvaTurma = new RefFormAvaTurma;
    $novaRefFormAvaTurma->setFkFormularioAvaliacao($_POST['fk_formulario_avaliacao']);
    $novaRefFormAvaTurma->setFkTurma($_POST['fk_turma']);
    $novaRefFormAvaTurma->adicionar();
...
<body>
  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Vincular Formulário a Turma</h1>
          </div>
          <div class="col-sm-6">
