  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index.php" class="brand-link">
      <img src="../../img/logobranca.png" alt="SISP Logo" class="brand-image"
           style="opacity: ">
      <span class="brand-text font-weight-light">Coordenador</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="cadastroacademicos.html" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Acadêmicos</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="cadastroprofessor.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Professor</p>
                </a>
              </li>
