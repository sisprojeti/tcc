...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28/05/2020 às 02:04
...
--
-- Estrutura para tabela `avaliador_projeti`
--

CREATE TABLE IF NOT EXISTS `avaliador_projeti` (
  `id_avaliador_projeti` int(11) NOT NULL AUTO_INCREMENT,
  `fk_professor` int(11) NOT NULL,
  `fk_projeti` int(11) NOT NULL,
  PRIMARY KEY (`id_avaliador_projeti`),
  KEY `fk_avaliador_projeti_professor1` (`fk_professor`),
  KEY `fk_avaliador_projeti_projeti1` (`fk_projeti`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Estrutura para tabela `formulario_avaliacao`
--
...
CREATE TABLE IF NOT EXISTS `nota` (
  ...
  `fk_professor` int(11) NOT NULL,
  PRIMARY KEY (`id_nota`),
  KEY `fk_nota_criterio1` (`fk_criterio`),
  KEY `fk_nota_aluno1` (`fk_aluno`),
  KEY `fk_nota_professor1` (`fk_professor`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Estrutura para tabela `ref_formulario_criterio`
--
...
--
-- Restrições para tabelas `avaliador_projeti`
--
...
--
-- Restrições para tabelas `formulario_avaliacao`
--
ALTER TABLE `formulario_avaliacao`
  ADD CONSTRAINT `fk_ref_criterio_formulario_turma1` FOREIGN KEY (`fk_turma`) REFERENCES `turma` (`id_turma`);
