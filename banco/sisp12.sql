...
--
-- Host: 127.0.0.1
-- Generation Time: 05-Mar-2020 às 16:01
...
CREATE TABLE IF NOT EXISTS `boletim` (
  ...
  KEY `fk_boletim_ref_aluno_projeti1` (`fk_ref_aluno_projeti`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
ALTER TABLE `boletim`
  ADD CONSTRAINT `fk_boletim_ref_aluno_projeti1` FOREIGN KEY (`fk_ref_aluno_projeti`) REFERENCES `ref_aluno_projeti` (`id_ref_aluno_projeti`);
